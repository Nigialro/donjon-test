...
abstract class Character
{
    ...
    /**
     * @param int $experienceXP
     * @return Character
     */
    public function setExperienceXP(int $experienceXP): Character
    {
     ...
     * @return Character
     */
    public function setExperienceLevel(int $experienceLevel): Character
    {
    ...
    public function giveLevel(experienceInterface $level): self
    {
        $level->setExperienced($this, $this->getExperienceLevel());
    ...
    public function giveXP(experienceInterface $xp): self
    {
        $xp->setExperienced($this, $this->getExperienceXP());

        $xp->addXP($xp);

        echo $this->getName()." get $xp EXP!".PHP_EOL;

        if(($this->getExperienceXP()) / ($this->getExperienceLevel()) >= 100) {
            while(((($this->getExperienceXP()) / 100) - ($this->getExperienceLevel())) > 1) {
                $this->giveLevel(1);
                echo $this->getName()." up 1 level!".PHP_EOL;
            }
        }
